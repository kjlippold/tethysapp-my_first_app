    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.my_first_app"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.my_first_app.tests.tests"

        To run tests in the MyFirstAppTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.my_first_app.tests.tests.MyFirstAppTestCase"

        To run only the test_if_tethys_platform_is_great function in the MyFirstAppTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.my_first_app.tests.tests.MyFirstAppTestCase.test_if_tethys_platform_is_great"
...
class MyFirstAppTestCase(TethysTestCase):
    """
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/my-first-app/')  # The final '/' is essential for all pages/controllers
